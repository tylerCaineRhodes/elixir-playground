defmodule HandlerTest do
  ...
  test "GET /api/bears" do
    ...
    [
      ...
      {"hibernating":false,"type":"Brown","name":"Yogi","id":11},
      {"hibernating":false,"type":"Brown","name":"Fozzie","id":12},
      {"hibernating":false,"type":"Sloth","name":"Baloo","id":13},
      {"hibernating":true,"type":"Cartoon","name":"Gummy","id":14}]
    """
  ...
  test "GET /about" do
    ...
    <blockquote>
      When we contemplate the whole globe as aone great dewdrop, striped and dotted
